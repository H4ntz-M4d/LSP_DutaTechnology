...
@section('content')
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 d-flex">
                    ...
                    <div class="card mb-6 mb-lg-0 shadow-light-lg lift lift-lg">
                        ...
                        <a class="card-img-top" href="#!">
                            <img src="assets/img/photos/berita-1.jpg" alt="..." class="img-fluid">
                        </a>
                        ...
                        <a class="card-body" href="#!">
                            ...
                            <p class="mb-0 text-body-secondary">
                                ...
                                Cumque veritatis vitae quas deserunt earum veniam minima iusto saepe,
                                tempora error impedit? Dolores quae pariatur odio, ab maiores ducimus.
                                Praesentium, dicta!
                            </p>
                ...
                <div class="col-12 col-md-6 col-lg-4 d-flex">
                    ...
                    <div class="card mb-6 mb-lg-0 shadow-light-lg lift lift-lg">
                        ...
                        <!-- Image -->
                        <a class="card-img-top" href="#!">
                            <img src="assets/img/photos/berita-2.jpg" alt="..." class="img-fluid">
                        </a>
                        ...
                        <a class="card-body" href="#!">
                            ...
                            <!-- Text -->
                            <p class="mb-0 text-body-secondary">
                                Cozy vibes are out and this summer you should focus on making customer's feel
                                brave.
                            </p>
                ...
                <div class="col-12 col-lg-4 d-flex">
                    ...
                    <div class="card shadow-light-lg lift lift-lg">
                        ...
                        <!-- Image -->
                        <a class="card-img-top" href="#!">
                            <img src="assets/img/photos/photo-13.jpg" alt="..." class="img-fluid">
                        </a>
                        ...
                        <a class="card-body my-auto" href="#!">
                            ...
                            <!-- Text -->
                            <p class="mb-0 text-body-secondary">
                                Once you have your rental posted, you should focus on how you can differentiate
                                your home with little touches.
                            </p>
    ...
    <!-- LATEST POSTS -->
    <section class="py-8 py-md-8 bg-gradient-light-white">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <!-- Image -->
                    <img src="assets/img/illustrations/illustration-7.png" class="img-fluid" alt="...">
                            ...
                            <div>
                                <div class="list-group list-group-flush">
                                    <a class="list-group-item text-reset text-decoration-none" href="#!"
                                        role="button" data-bs-toggle="collapse" data-bs-target="#helpOne"
                                        aria-expanded="false" aria-controls="helpOne">

                                        <p class="fw-bold fs-sm" id="helpOneHeading">
                                            Klaster Penyusunan Laporan Keuangan Berbasis SAK ETAP.
                                        </p>
                                        <p class="fs-sm text-body-secondary">
                                            (Dapat dilakukan secara Luring atau Daring)
                                        </p>
                                        <div class="accordion-collapse collapse" id="helpOne"
                                            aria-labelledby="helpOneHeading" data-bs-parent="#helpAccordionOne">
                                            <div class="accordion-body">

                                                <!-- Text -->
                                                <p class="text-gray-700">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt rerum
                                                    minima a possimus, amet perferendis, temporibus obcaecati pariatur.
                                                    Reprehenderit magnam necessitatibus vel culpa provident quas nesciunt
                                                    sunt aut cupiditate fugiat! Lorem ipsum dolor sit amet, consectetur
                                                    adipisicing elit. Sunt rerum minima a possimus, amet perferendis,
                                                    temporibus obcaecati pariatur. Reprehenderit magnam necessitatibus vel
                                                    culpa provident quas nesciunt sunt aut cupiditate fugiat!
                                                </p>
                                    ...
                                    <a class="list-group-item text-reset text-decoration-none" href="#!"
                                        role="button" data-bs-toggle="collapse" data-bs-target="#helpTwo"
                                        aria-expanded="false" aria-controls="helpTwo">

                                        <p class="fw-bold fs-sm" id="helpTwoHeading">
                                        ...
                                        <div class="accordion-collapse collapse" id="helpTwo"
                                            aria-labelledby="helpTwoHeading" data-bs-parent="#helpAccordionTwo">
                                            <div class="accordion-body">
                                    ...
                                    <a class="list-group-item text-reset text-decoration-none" href="#!"
                                        role="button" data-bs-toggle="collapse" data-bs-target="#helpThree"
                                        aria-expanded="false" aria-controls="helpThree">

                                        <p class="fw-bold fs-sm" id="helpThreeHeading">
                                        ...
                                        <div class="accordion-collapse collapse" id="helpThree"
                                            aria-labelledby="helpThreeHeading" data-bs-parent="#helpAccordionThree">
                                            <div class="accordion-body">
                                    ...
                                    <a class="list-group-item text-reset text-decoration-none" href="#!"
                                        role="button" data-bs-toggle="collapse" data-bs-target="#helpFour"
                                        aria-expanded="false" aria-controls="helpFour">

                                        <p class="fw-bold fs-sm" id="helpFourHeading">
                                        ...
                                        <div class="accordion-collapse collapse" id="helpFour"
                                            aria-labelledby="helpFourHeading" data-bs-parent="#helpAccordionFour">
                                            <div class="accordion-body">
                                    ...
                                    <a class="list-group-item text-reset text-decoration-none" href="#!"
                                        role="button" data-bs-toggle="collapse" data-bs-target="#helpFive"
                                        aria-expanded="false" aria-controls="helpFive">

                                        <p class="fw-bold fs-sm" id="helpFiveHeading">
                                            Klaster Pengelolaan Harga Pokok Produk
                                        </p>
                                        <p class="fs-sm text-body-secondary mb-0">
                                            (Hanya dilakukan secara Luring)
                                        </p>

                                        <div class="accordion-collapse collapse" id="helpFive"
                                            aria-labelledby="helpFiveHeading" data-bs-parent="#helpAccordionFive">
                                            <div class="accordion-body">
                                    ...
                                    <a class="list-group-item text-reset text-decoration-none" href="#!"
                                        role="button" data-bs-toggle="collapse" data-bs-target="#helpSix"
                                        aria-expanded="false" aria-controls="helpSix">

                                        <p class="fw-bold fs-sm" id="helpSixHeading">
                                        ...
                                        <div class="accordion-collapse collapse" id="helpSix"
                                            aria-labelledby="helpSixHeading" data-bs-parent="#helpAccordionSix">
                                            <div class="accordion-body">
                    ...
                    <div class="card card-border border-success shadow-light-lg mb-6 mb-md-8" data-aos="fade-up"
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                <div class="list-group list-group-flush">
                                    <a class="list-group-item text-reset text-decoration-none" href="#!"
                                        role="button" data-bs-toggle="collapse" data-bs-target="#helpSeven"
                                        aria-expanded="false" aria-controls="helpSeven">

                                        <p class="fw-bold fs-sm" id="helpSevenHeading">
                                            KUALIFIKASI II: Teknisi Akuntansi Yunior
                                        </p>
                                        <p class="fs-sm text-body-secondary">
                                            (Dapat dilakukan secara Luring atau Daring)
                                        </p>
                                        <div class="accordion-collapse collapse" id="helpSeven"
                                            aria-labelledby="helpSevenHeading" data-bs-parent="#helpAccordionSeven">
                                            <div class="accordion-body">
                                    ...
                                    <a class="list-group-item text-reset text-decoration-none" href="#!"
                                        role="button" data-bs-toggle="collapse" data-bs-target="#helpEight"
                                        aria-expanded="false" aria-controls="helpEight">

                                        <p class="fw-bold fs-sm" id="helpEightHeading">
                                            KUALIFIKASI III: Teknisi Akuntansi Pratama
                                        </p>

                                        <div class="accordion-collapse collapse" id="helpEight"
                                            aria-labelledby="helpEightHeading" data-bs-parent="#helpAccordionEight">
                                            <div class="accordion-body">
                                    ...
                                    <a class="list-group-item text-reset text-decoration-none" href="#!"
                                        role="button" data-bs-toggle="collapse" data-bs-target="#helpNine"
                                        aria-expanded="false" aria-controls="helpNine">

                                        <p class="fw-bold fs-sm" id="helpNineHeading">
                                            KUALIFIKASI IV: Teknisi Akuntansi Muda
                                        </p>

                                        <div class="accordion-collapse collapse" id="helpNine"
                                            aria-labelledby="helpNineHeading" data-bs-parent="#helpAccordionNine">
                                            <div class="accordion-body">
