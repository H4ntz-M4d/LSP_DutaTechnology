        ...
        <div class="container-fluid px-md-0">
            <div class="row justify-content-between gx-0 mx-md-0">
                <div class="col-12 col-md-4 position-md-sticky d-flex align-items-center vh-md-100 mx-auto" style="top: 0;">
                    <!-- Sidebar -->
                    <aside class="flex-grow-1 py-8 py-md-10" data-aos="fade-up">

                        <!-- Brand -->
                        <div class="img-fluid mb-4 text-body" style="max-width: 140px;">
                            <svg viewBox="0 0 222 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Text -->
                        <p class="fs-lg mb-7 text-body-secondary">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                ...
                                <h6 class="d-flex mb-0 text-uppercase">
                                    Year <span class="ms-auto">2023</span>
                                </h6>
                            ...
                            <li class="list-group-item">
                                ...
                                <!-- Heading -->
                                <h6 class="d-flex mb-0 text-uppercase">
                                    Month <span class="ms-auto"> 20 August</span>
                                </h6>
                            ...
                            <li class="list-group-item">
                                ...
                                <!-- Heading -->
                                <h6 class="d-flex mb-0 text-uppercase">
                                    Day <span class="ms-auto"> sunday</span>
                                </h6>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <!-- Card -->
                                    <div
                                        class="card card-row shadow-light-lg bg-cover overlay overlay-dark overlay-80 text-white mb-6">
                                        <div class="row gx-0">
                                            <div class="col-12">
                                            ...
                                            <a class="col-12 col-md-6 order-md-2 bg-cover card-img-end"
                                                ...
                                                <div class="shape shape-start shape-fluid-y text-white d-none d-md-block">
                                                    <svg viewBox="0 0 112 690" fill="none"
                                            ...
                                            <div class="col-12 col-md-6 order-md-1">
                                                ...
                                                <a class="card-body" href="#!">
                                                    ...
                                                    <p class="mb-0 text-body-secondary">
                                                        This is the body text of the blog post to give visitors an idea
                                                        of what the post is about beyond just the title. It can be a
                                                        long snippet, a short snippet, whatever you prefer the size of
                                                        card and description to be.
                                                    </p>
                                    ...
                                    <div
                                        ...
                                        <div class="row gx-0">
                                            ...
                                            <a class="col-12 col-md-6 bg-cover card-img-start"
                                                style="background-image: url(assets/img/photos/photo-28.jpg);"
                                                href="#!">

                                                <!-- Image (placeholder) -->
                                                <img src="assets/img/photos/photo-28.jpg" alt="..."
                                                    class="img-fluid d-md-none invisible">
                                    ...
                                    <!-- Card -->
                                    <div class="card card-row shadow-light-lg bg-cover overlay overlay-dark overlay-80 text-white mb-6"
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <a class="card-body" href="#!">
                                                    ...
                                                    <p class="mb-0 text-white text-opacity-80">
                                                        It's easy to add a background image for the entire card, plus
                                                        make text more legible by adding an overlay across the
                                                        background with simple utility classes. These are all generated
                                                        from the theme's variables!
                                                    </p>
                                    ...
                                    <!-- Card -->
                                    <div class="card card-row shadow-light-lg bg-cover overlay overlay-gradient-dark-end overlay-60 text-white mb-6"
                                        style="background-image: url(assets/img/photos/photo-30.jpg);">
                                        <div class="row gx-0 justify-content-end">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <a class="card-body" href="#!">
                                                    ...
                                                    <!-- Text -->
                                                    <p class="mb-0 text-white text-opacity-80">
                                                        This blog card example shows a background image, but instead of
                                                        an even wash across the entire background, it's a gradient from
                                                        right to left controlled by another simple utility class.
                                                    </p>
